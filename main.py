...
for activation in activation_array:
    ...
    #Строим графики
    save_graph(num_layers_array, accuracy_array, activation, "layers", models_number, models_number)
    save_graph(num_neurons_array, accuracy_array, activation, "neurons", models_number, models_number)
